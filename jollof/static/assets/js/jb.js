...
$(window).resize(function(){
    if($(window).width() < 768){
        jb.initRightMenu();
    } else if(!burger_menu && jb.misc.navbar_menu_visible){
        jb.toggleSidebarMenu();
    }
});
...
jb = {
    ...
    initRightMenu: function(){
         if(!navbar_initialized){
            ...
            $toggle.click(jb.toggleSidebarMenu);
    ...
    toggleSidebarMenu: function(){
        if(jb.misc.navbar_menu_visible == 1) {
            $('html').removeClass('nav-open');
            jb.misc.navbar_menu_visible = 0;
            $('.body-click').remove();
             setTimeout(function(){
    ...
    initCollapseArea: function(){
        $('[data-toggle="jb-collapse"]').each(function () {
            var thisdiv = $(this).attr("data-target");
            $(thisdiv).addClass("jb-collapse");
        });

        $('[data-toggle="jb-collapse"]').hover(function(){
            var thisdiv = $(this).attr("data-target");
